...
function custom_scripts() {
  wp_register_style('main-style', get_template_directory_uri().'assets/css/screen.min.css', array(), true);
  wp_enqueue_script('main-script', get_template_directory_uri() . 'assets/js/script.js', array ());
}
